...
%
%\begin{itemize}
%    \item (2020) Organizer, Mini-symposium, ``Machine learning for multiphase flows'', IACM Conference on Mechanistic Machine Learning and Digital Twins for Computational Science, Engineering \& Technology
